...
exports.default = express_1.Router()
    ...
    .use(shared_middlewares_1.bodyParsingHandler)
    .all('/666/:splat*', flattenUrl)
    .all('/664/:splat*', branch({ read: shared_middlewares_1.goNext, write: loggedOnly }), flattenUrl)
    .all('/660/:splat*', loggedOnly, flattenUrl)
    .all('/644/:splat*', branch({ read: shared_middlewares_1.goNext, write: privateOnly }), flattenUrl)
    .all('/640/:splat*', branch({ read: loggedOnly, write: privateOnly }), flattenUrl)
    .all('/600/:splat*', privateOnly, flattenUrl)
    .all('/444/:splat*', readOnly, flattenUrl)
    .all('/440/:splat*', loggedOnly, readOnly, flattenUrl)
    .all('/400/:splat*', privateOnly, readOnly, flattenUrl)
